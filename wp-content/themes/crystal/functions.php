...
add_image_size('Portfolio Full', 600, 340, TRUE);
...
function crystal_footer_creds_text($creds) {
    return __('Copyright', 'genesis') . ' [footer_copyright] Heritage Custom Masonry';
}
...
function custom_footer_backtotop_text($backtotop) {
    $backtotop = '<span id="made_in_usa">Made in the United States</span>';
    return $backtotop;
}
